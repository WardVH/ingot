...
// `embedded` renders it as a story chapter: the shell's narration bar replaces the long captions.
export default function TimeMachine({ scene, embedded = false }: { scene: RealScene; embedded?: boolean }) {
